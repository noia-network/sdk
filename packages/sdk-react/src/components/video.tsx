...
interface VideoHtmlPropsFix extends React.DetailedHTMLProps<React.VideoHTMLAttributes<HTMLVideoElement>, HTMLVideoElement> {
    ref?: any;
}
...
export interface VideoProps extends VideoHtmlPropsFix {
    ...
    mimeType?: string;
    sourceProps?: React.DetailedHTMLProps<React.SourceHTMLAttributes<HTMLSourceElement>, HTMLSourceElement>;
    ref?: React.Ref<Video>;
}
...
export class Video extends React.Component<VideoProps, VideoState> {
    ...
    public static getDerivedStateFromProps(nextProps: VideoProps, prevState: VideoState): VideoState {
    ...
    protected getProps(props: VideoProps): React.DetailedHTMLProps<React.VideoHTMLAttributes<HTMLVideoElement>, HTMLVideoElement> {
        const { src, mimeType, loaderComponent, ref, sourceProps, ...restProps } = props;
        return restProps;
    }
    ...
    public render(): JSX.Element | null {
        if (this.props.loaderComponent == null && this.state.base64 == null) {
            return null;
        } else if (this.props.loaderComponent != null && this.state.base64 == null) {
            return this.props.loaderComponent;
        }

        return (
            <video ref={component => (this.element = component)} {...this.getProps(this.props)}>
                <source
